...
class Alarm:
    ...
    def set_severity(self, severity, reason):
        ...
        if severity == AlarmSeverity.NONE and self.quiescent:
            # ignore repeated NONE when alarm is already reset
            return False
    ...
    def acknowledge(self, severity, user):
        """Acknowledge the alarm. A no-op if quiescent or acknowledged.
        ...
        """
        if self.quiescent or self.acknowledged:
            return False
    ...
    def unacknowledge(self):
        """Unacknowledge the alarm. A no-op if quiescent or not acknowledged.
        ...
        updated : `bool`
            ...
            False otherwise.
        """
        if self.quiescent or not self.acknowledged:
            return False
    ...
    @property
    def quiescent(self):
        """True if alarm is quiescent: severity = max severity = NONE.
        """
